      ...
      <div className="items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
        <div className="flex flex-col items-center pt-8">
          ...
          <div className="flex space-x-5 pt-6">
            ...
            <a
              href="https://www.linkedin.com/in/justina-oluyomi-02155b264/"
              target="_blank"
            >
              <svg
                viewBox="0 0 1024 1024"
        ...
        <div className="prose max-w-none prose-lg pt-8 pb-7 dark:prose-invert xl:col-span-2">
          ...
          <p className="text-xl mb-10">
            ...
            and friends in my community. React speeed and interactiveness is
            attractive. Its virtual DOM and efficient rendering mechanisms
            allowed me to create dynamic user interfaces that responded to user
            actions in real-time.
          </p>
          <p className="text-xl mb-10">
            As a software developer who is focus on frontend development, I am
            ready to work with my acquired skills for organisation, professional
            and personal growth &#128508;. I am thrilled to continue this
            journey, horning my skills, and inspiring others in the process.
          </p>
        </div>
      </div>
    </div>
