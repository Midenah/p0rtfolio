    ...
    <div className="divide-y divide-gray-100 dark:divide-gray-700">
      ...
      <div className="items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
        <div className="prose max-w-none prose-lg pt-8 pb-7 dark:prose-invert xl:col-span-2">
          ...
          />
          <a
            className="text-center text-3xl bg-gradient-to-r from-cyan-500 to-teal-500 m-10"
            href="https://denah-nurasound.netlify.app/"
          >
            Click here
          </a>
        </div>
        <div className="prose max-w-none prose-lg pt-8 pb-7 dark:prose-invert xl:col-span-2">
          ...
          <a
            className="text-center text-3xl bg-gradient-to-r from-cyan-500 to-teal-500 m-10"
            href="https://denah-yoruba-aloud.netlify.app/"
          >
            Click here
          </a>
        </div>
        <div className="prose max-w-none prose-lg pt-8 pb-7 dark:prose-invert xl:col-span-2">
          ...
          <a
            className="text-center text-3xl bg-gradient-to-r from-cyan-500 to-teal-500 m-10"
            href="https://denah-shoppy.netlify.app/"
          >
            Click here
          </a>
        </div>
